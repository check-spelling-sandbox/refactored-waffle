...
This is reported when entries in [check_extra_dictionaries](Configuration.md#checkextradictionaries) are not found. See [dictionary-not-found](#dictionary-not-found).
...
This is reported when entries in [extra_dictionaries](Configuration.md#extradictionaries) are not found. See [dictionary-not-found](#dictionary-not-found).
